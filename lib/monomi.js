module.exports = monomi;


monomi.getHeader = getHeader;

// support deprecated monomi.detectBrowserType() usage
monomi.detectBrowserType = monomi;


function monomi(options) {
    ...
    function detectBrowserType(request) {
    ...
    function middleware(request, response, next) {
        ...
        request.monomi = {
            'browserType' : detectBrowserType(request)
        };
    ...
    middleware.detect = detectBrowserType;
...
function getHeader(request, header, tryPrefix, defaultValue) {
